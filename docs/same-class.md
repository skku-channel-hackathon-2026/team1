...
캠퍼스는 자과캠(율전) 하나만 다룬다(팀 결정: 구분이 복잡함). 시드는 소프트웨어학과 중심 29명이다. 예시 시간표와 같은 학과 23명은 겹치는 과목 수가 5·4·3·2·1·0개 순으로 1·2·3·5·6·6명이라 점수가 91점부터 0점까지 고르게 퍼진다. 0개인 사람도 같은 건물이나 공강으로 걸린다. `campus` 필드는 데이터 모델에 남아 있어 나중에 인사캠을 되살릴 수 있다.
