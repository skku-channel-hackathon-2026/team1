...
- 보너스 = 체인(같은 수업 직후 둘 다 공강) `1.0` · 점심 겹침 요일 `0.5`. 공강 계열은 같은 수업보다 작게 잡았다(팀 결정). 동행 이동 보너스는 제거했다.
...
인사캠 1순위 「하늘」(자과캠은 「우주」)은 53점(같은 강의실 28 · 공강 25), 수요일 `2교시 같이 듣기 → 공강 1시간 → 4교시 같이 듣기 → 공강 1시간 → 6교시 같이 듣기`가 나온다.
