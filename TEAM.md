...
- 채널톡 앱: `SKKU 2026 Team1` (`6aab7be513f451690580`)
- 앱 관리: https://channel.works/-/developers/apps/6aab7be513f451690580/general
- 공통 채널: 성균관대 해커톤
- 검증 그룹: https://channel.works/xd1l0/team-chat/groups/609235
- 서버: https://skku-team1.vercel.app
- 전용 D1: `skku-team1` (`c6cbc4c0-5c6d-4556-b368-1f8742e3e3b0`)
- 자동 배포: PR 머지 후 main CI가 성공하면 웹훅으로 원격 D1 마이그레이션 후 Cloudflare 자동 배포를 실행합니다. 실행 대기·빌드 시간이 필요합니다.

참가팀 11개 앱과 준비위 team0 앱은 같은 채널에 설치되어 있습니다. `/tutorial` 목록에서 `SKKU 2026 Team1`을 선택하세요.
